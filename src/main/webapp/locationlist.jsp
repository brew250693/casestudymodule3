            ...
            <table border="1" cellpadding="5">
                ...
                <c:forEach var="location" items="${listLocation}">
                    <tr>
                        ...
                        <td><c:out value="${location.book_amount}"/></td>
                        <td><c:out value="${location.book_quanity}"/></td>
                        <td>
                            <a href="/location?action=edit&id=${location.id}">Edit</a>
                            <a href="/location?action=delete&id=${location.id}">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
