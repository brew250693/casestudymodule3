        ...
        <nav class="navbar navbar-expand-md bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav mr-auto">
                    <a href="/users?action=index" class="nav-item nav-link active">Home</a>
                    <a href="/users?action=product-list" class="nav-item nav-link">Books</a>
                    <a href="/users?action=product-detail" class="nav-item nav-link">Book Detail</a>
                    <a href="/users?action=my-account" class="nav-item nav-link">My Account</a>
                </div>
                <div class="navbar-nav ml-auto">
                    <div class="nav-item dropdown">
                        <a href="/users?action=signup" class="nav-item nav-link"><c:out value="${abc}" /></a>
                    </div>
                </div>
            </div>
        </nav>
