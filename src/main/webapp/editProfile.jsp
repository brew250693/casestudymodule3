                    ...
                    <div class="navbar-nav ml-auto">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="/users?action=account-details" class="dropdown-item active">Account Details</a>
                                <a href="/users?action=change-password" class="dropdown-item">Change Password</a>
